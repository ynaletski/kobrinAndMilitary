...
//10.06.2021 YN
#if (PressureDrop == 1)
  &Press_Drop,       // 37 F1074 Перепад давления на фильтре Мпа
#elif (PressureDrop == 2)
  &P_before,           // 37 F1074 давление до фильтра
  &P_after,            // 38 F1076 давление после фильтра
  &P_diff,             // 39 F1078 перепад давления на фильтре
#endif
