...
extern unsigned int OUT_VAR;  // ���ﭨ� ������� ��室��
extern unsigned int INP_VAR;  // ���ﭨ� ������� �室��
extern unsigned int INP_VAR_c;  // ���ﭨ� ������� �室��
...
extern int fl_GO;
extern int fl_EQ;     // 䫠� ��ࠢ������� �������� �१ MVD
extern int flagS_ES;  // �ਧ��� ��⠭��� �� ������ ES
extern int flagS_UZA; // �ਧ��� ��⠭��� �� ������⢨� UZA
